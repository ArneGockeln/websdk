...
class User implements IDBObject
{
    ...
    public function load()
    {
        ...
        } else if(!is_null($this->getEmail()) && isSecureEmail($this->getEmail())){
            $sql .= " email = '" . $mysql->getEscapedString($this->getEmail()) . "'";
        } else {
            throw new \Exception(_('No valid ID, Username nor Email was found!'));
        }
